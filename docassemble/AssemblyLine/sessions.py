...
def get_saved_interview_list(
    ...
    query_draft = """
        WITH filtered_userdict AS (
            SELECT userdict.indexno as indexno, userdict.key as key, userdict.dictionary as _unused_dictionary, userdict.modtime as modtime, userdict.user_id as user_id, userdict.filename as filename
