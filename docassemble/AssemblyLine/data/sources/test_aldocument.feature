...
Scenario: User can upload exhibits
  ...
  And I get to "end alexhibit tests" with this data:
    | var | value | trigger |
    | x.there_are_any | True | exhibit_doc_defaults_1.exhibits.there_are_any |
    | x[0].title | Defaults 1 | exhibit_doc_defaults_1.exhibits.there_are_any |
    | x[0].pages | test_alexhibit_docx_1.docx | exhibit_doc_defaults_1.exhibits.there_are_any |
...
Scenario: User adds only a docx exhibit
  ...
  And I get to "end alexhibit tests" with this data:
    | var | value | trigger |
    | x.there_are_any | True | exhibit_doc_defaults_1.exhibits.there_are_any |
    | x[0].title | DOCX only | exhibit_doc_defaults_1.exhibits.there_are_any |
    | x[0].pages | test_alexhibit_docx_1.docx | exhibit_doc_defaults_1.exhibits.there_are_any |
